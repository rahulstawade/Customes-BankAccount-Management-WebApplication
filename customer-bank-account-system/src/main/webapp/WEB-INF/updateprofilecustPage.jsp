...
<body>
	...
	<div class="container">
		...
		<s:form action="updateCustomerAction" method="post" theme="bootstrap"
			cssClass="well form-horizontal" id="updateForm">

			<s:textfield name="userForm.userId" id="" label="User-ID"
				tooltip="Enter your User-Id"
				inputPrependIcon="glyphicon glyphicon-user" disabled="true">
			</s:textfield>
